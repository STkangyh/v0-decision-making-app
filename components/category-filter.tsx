...
const CATEGORY_META: Record<Category, { icon: React.ElementType; active: string; idle: string }> = {
  ...
  '스포츠': { icon: Trophy,       active: 'bg-green-500  text-white border-green-500',  idle: 'bg-green-50  text-green-600  border-green-200  hover:bg-green-100  dark:bg-green-900/30  dark:text-green-300  dark:border-green-700' },
  '친구': { icon: Handshake,      active: 'bg-amber-500  text-white border-amber-500',  idle: 'bg-amber-50  text-amber-600  border-amber-200  hover:bg-amber-100  dark:bg-amber-900/30  dark:text-amber-300  dark:border-amber-700' },
